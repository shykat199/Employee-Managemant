            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <div>
                            <p class="float-left font extrabold">Create New Employee</p>
                        </div>
                        <div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="container">
                            ...
                            <form @submit.prevent="storeEmployee()" method="POST" action="">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <Datepicker name="birthdate" v-model="form.birthdate" class="form-control"/>
                                ...
                                <div class="row mb-3">
                                    <label for="date_hired"
                                        ...
                                        class="fa-solid fa-calendar-days"></i></label>
                                    <div class="col-md-6">
                                        <Datepicker name="date_hired" v-model="form.date_hired" class="form-control"/>
                                        <!--                                        @error('first_name')-->
                                        <!--                                        <span class="invalid-feedback" role="alert">-->
                                        <!--                                        <strong>{{ $message }}</strong>-->
                                        <!--                                    </span>-->
